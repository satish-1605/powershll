...
#deploying availibility set
$availsetname= "Avail-set"
$ppgname= "ppg-set"
$ResourceGrpname ="myRG"
$location= "North Europe"

#New-AzProximityPlacementGroup -ResourceGroupName $ResourceGrpname -Location $location -Name $ppgname 
$ppgname= "ppg-set"
$ppg_details=Get-AzProximityPlacementGroup -ResourceGroupName $ResourceGrpname  -Name $ppgname | Select-Object Id
$ppg_details.Id

$avsetdetail=New-AzAvailabilitySet -ResourceGroupName $ResourceGrpname -name $availsetname  -Location $location `
-PlatformUpdateDomainCount 10 -PlatformFaultDomainCount 2 -ProximityPlacementGroupId $ppg_details.Id

$avsetdetail=get-AzAvailabilitySet -ResourceGroupName $ResourceGrpname -Name $availsetname
