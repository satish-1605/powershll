#using functions to call an object
...
$AccountName = "scalesetstorage1218275"
$ContainerName="scripts"
$BlobName="IIS_Config.ps1"

$blobUri=get-bloburi $ResourceGroupName $AccountName $ContainerName $BlobName
$settings=@{"fileUris"=$blobUri}

$StorageAccountKeyValue= get-storageaccountkeyvalue $ResourceGroupName $AccountName 
